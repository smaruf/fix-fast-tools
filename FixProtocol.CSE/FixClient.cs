...
/// <summary>
/// FIX Client implementation for CSE-BD (Chittagong Stock Exchange - Bangladesh)
...
public class FixClient : IApplication
{
    ...
    {
        _logger.LogInformation("Logged on to CSE-BD: {SessionID}", sessionID);
    ...
    {
        _logger.LogInformation("Logged out from CSE-BD: {SessionID}", sessionID);
        _isLoggedOn = false;
    }
